...
namespace twitCurlDefaults
{
    ...
    const std::string TWITCURL_GEOSEARCHQUERYSTRING = "query=";
    ...
    const std::string TWITCURL_SINCE_ID = "since_id=";
    const std::string TWITCURL_MAX_ID = "max_id=";
...
namespace twitterDefaults
{
    ...
    const std::string TWITCURL_GEO_SEARCH_URL = "https://api.twitter.com/1.1/geo/search";
    ...
    const std::string TWITCURL_PUBLIC_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/public_timeline";
    const std::string TWITCURL_FEATURED_USERS_URL = "https://api.twitter.com/1.1/statuses/featured";
    const std::string TWITCURL_FRIENDS_TIMELINE_URL = "https://api.twitter.com/1.1/statuses/friends_timeline";
    const std::string TWITCURL_MENTIONS_URL = "https://api.twitter.com/1.1/statuses/mentions";
    const std::string TWITCURL_USERTIMELINE_URL = "https://api.twitter.com/1.1/statuses/user_timeline";

    /* Users URLs */
    const std::string TWITCURL_LOOKUPUSERS_URL = "https://api.twitter.com/1.1/users/lookup";
    const std::string TWITCURL_SHOWUSERS_URL = "https://api.twitter.com/1.1/users/show";
    const std::string TWITCURL_SHOWFRIENDS_URL = "https://api.twitter.com/1.1/statuses/friends";
    const std::string TWITCURL_SHOWFOLLOWERS_URL = "https://api.twitter.com/1.1/statuses/followers";
    ...
    /* Account URLs */
    const std::string TWITCURL_ACCOUNTRATELIMIT_URL = "https://api.twitter.com/1.1/account/rate_limit_status";

    /* Favorites URLs */
    const std::string TWITCURL_FAVORITESGET_URL = "https://api.twitter.com/1.1/favorites";
    ...
    /* Saved Search URLs */
    const std::string TWITCURL_SAVEDSEARCHGET_URL = "https://api.twitter.com/1.1/saved_searches";
    const std::string TWITCURL_SAVEDSEARCHSHOW_URL = "https://api.twitter.com/1.1/saved_searches/show/";
    const std::string TWITCURL_SAVEDSEARCHCREATE_URL = "https://api.twitter.com/1.1/saved_searches/create";
    const std::string TWITCURL_SAVEDSEARCHDESTROY_URL = "https://api.twitter.com/1.1/saved_searches/destroy/";

    /* Trends URLs */
    const std::string TWITCURL_TRENDS_URL = "https://api.twitter.com/1.1/trends";
    const std::string TWITCURL_TRENDSDAILY_URL = "https://api.twitter.com/1.1/trends/daily";
    const std::string TWITCURL_TRENDSCURRENT_URL = "https://api.twitter.com/1.1/trends/current";
    const std::string TWITCURL_TRENDSWEEKLY_URL = "https://api.twitter.com/1.1/trends/weekly";
    const std::string TWITCURL_TRENDSAVAILABLE_URL = "https://api.twitter.com/1.1/trends/available";
...
public:
    ...
    bool search( std::string& searchQuery, unsigned long long since_id =0, unsigned long long max_id = 0);
    bool search( std::string& searchQuery, unsigned long long since_id, unsigned long long max_id, std::string & lang);
    bool geoSearch( std::string& searchQuery );
    ...
    bool timelineUserGet( bool trimUser /* in */, bool includeRetweets /* in */, unsigned int tweetCount /* in */, unsigned long long since_id, unsigned long long int max_id, std::string userInfo = "" /* in */, bool isUserId = false /* in */ );
    ...
    bool usersGet( std::string& usersInfo /* in */, bool isUserId = false /* in */ );
    ...
    bool friendsIdsGet( std::string& userInfo /* in */, std::string& cursor/* in */, bool isUserId = false /* in */ );

    bool followersIdsGet( std::string& userInfo /* in */, bool isUserId = false /* in */ );
    bool followersIdsGet( std::string& userInfo /* in */, std::string& cursor /* in */, bool isUserId = false /* in */);
    ...
    bool favoritesGet( bool trimUser /* in */, bool includeRetweets /* in */, unsigned int tweetCount /* in */, unsigned long long since_id, unsigned long long int max_id, std::string userInfo = "" /* in */, bool isUserId = false /* in */ );
